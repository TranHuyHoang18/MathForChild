    ...
    <nav class="navbar navbar-expand-sm  Mymenu">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto list_item">
                <li class="nav-item">
                    <a href="{{url('teacher/')}}" class="nav-link">Trang chủ</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('teacher/class/home')}}" class="nav-link">Quản lý lớp</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <form id="logout-form" action="{{ route('teacher.auth.logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                    </div>
                </li>
