...
@section('content')
   <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Đăng kí tài khoản phụ huynh') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('parent.register.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="id_child" class="col-md-4 col-form-label text-md-right">{{ __('ID học sinh') }}</label>

                                <div class="col-md-6">
                                    <input id="id_child" type="text" class="form-control @error('id_child') is-invalid @enderror" name="id_child" value="{{ old('id_child') }}" required autocomplete="id_child" autofocus>
